...
## Descripción General
La **Crusher API** permite obtener información sobre el stock de productos de Crusher. Como tambien enviar y procesar ordenes, el acceso a informacion extra como su foto, en caso de tener. Está diseñada para facilitar el acceso a los datos sobre productos, disponibilidad y precios.
